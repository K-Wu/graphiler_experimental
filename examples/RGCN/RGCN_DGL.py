...
class RGCN_DGL(nn.Module):
    def __init__(self, in_dim, out_dim, num_rels):
        ...
        self.layer1 = RelGraphConv(in_dim, out_dim, num_rels)
...
class RGCN_DGL_hetero(nn.Module):
    def __init__(self, in_dim, out_dim, rel_names, num_rels):
        super(RGCN_DGL_hetero, self).__init__()
        self.layer1 = RelGraphConvHetero(in_dim, out_dim, rel_names, num_rels)
